...
export async function POST(
  ...
  try {
    ...
    const upvotes = question.votes.upvotes.map((id: any) => id.toString());
    const downvotes = question.votes.downvotes.map((id: any) => id.toString());
    ...
    const newVoteCount = updatedQuestion.votes.upvotes.length - updatedQuestion.votes.downvotes.length;
